...
image: /img/etc/love-md.png
category: tech
tags: [마크다운, Markdown, GitHub, md]
comments: true
---
...
상단의 링크를 따라가면 Jekyll이 자동으로 웹페이지로 변환해준다.

[take 5 minutes to learn how to write in markdown](http://markdowntutorial.com/)

또한 상단의 링크에서는 5분만에 일반적인 텍스트를 굵게/기울임/제목/표 등으로 변환하는 방법을 배울 수 있다고 한다..
