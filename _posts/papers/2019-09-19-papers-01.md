...
기존에 제시되었던 Image captioning을 해결하는 수많은 방법들은 결국 Supervised라는 틀을 벗어나지 못했습니다. 본 논문에서는 Visual concept와 Sentence를 동일한 latent space에 project하고, GAN을 통해 의미론적으로 유사한 feature간의 distance를 줄이려는 접근이 매우 인상적이었습니다만 Visual concept, Generated sentence, sentence from corpus를 모두 align시키려는 시도때문에 많은 Loss function이 생겨나는건 어쩔 수 없었습니다. 여기서 metric learning 혹은 representation learning을 통해 보다 더 나은 방법을 제시할 수 있는 가능성(?)도 보입니다. 이후에 기회가 되면 metric learning에 대해서도 다루어보도록 하겠습니다.
