...
| [***서론 & 관련연구***](https://sangminwoo.github.io/2019-09-19-papers-01#서론) |
|:--:|
| [***Unsupervised Image Captioning***](https://sangminwoo.github.io/2019-09-19-papers-01#Unsupervised-Image-Captioning) |
...
Visual concept과 Sentence를 동일한 latent space에 project하고, GAN을 통해 의미론적으로 유사한 feature간의 distance를 줄이려는 접근은 흥미롭긴 하지만 Visual concept, Generated sentence, sentence from corpus를 모두 align시키려는 시도 때문에 Objective function과 더불어 parameter가 증가하는 한계를 보였습니다. 다양한 distance metric에 대한 ablation study를 통해 일종의 가이드라인을 제시해주었다면 좋았을 것 같습니다.
