...
show-avatar: true
category: papers
tags: [NAACL, NAACL2016, Visual Storytelling, Image Captioning, Sequential vision-to Language, Photo stream captioning]
comments: true
---
...
|저자의 [GitHub](https://github.com/Pendulibrium/ai-visual-storytelling-seq2seq)에서 가져온 Storytelling 결과들|
|:--:|
...
논문에서는 Sequential images-to-story를 해결하는 breakthrough를 제시하지는 않지만, baseline과 함께 Visual Storytelling이라는 새로운 화두를 던져주었습니다. 단순히 Visual concept을 Text로 풀어내는 것에서 그치지 않고 감정이나 맥락과 같은 추상적인 개념들을 이해하고 전반적인 상황을 추론할 수 있어야합니다. 최근 인스타그램이나 페이스북을 통한 사진 공유가 활발한 시대인만큼 매우 핫한 주제로 다루어지고 있는것 같습니다.
...
이후에 Visual Storytelling에 대한 어떠한 방법론을 제안하는 논문도 다루어볼 예정입니다.
